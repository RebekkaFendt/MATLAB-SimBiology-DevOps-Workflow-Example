...
&#8195;[Part 1:  Getting the workshop files and configuring GitHub for automated testing and results publishing](#TMP_1008)
 
&#8195;[Part 2:  Generating your first tests](#TMP_0514)
 
&#8195;[Part 3:  Finding existing tests and measuring coverage](#TMP_5f93)
 
&#8195;[Part 4:  Updating badges, committing our changes, and pushing to GitHub](#TMP_0238)
 
&#8195;[Part 5:  Create a pull request, watch GitHub Actions automatically test your changes and publish results](#TMP_9fa7)
 
&#8195;[Part 6:  Compile the App in the CI workflow and download the artifact](#TMP_899a)
 
&#8195;[Workshop wrap\-up and additional information](#TMP_3e93)
...
**Part 1.4:  Let's run the CI workflow once**

We will start the CI workflow manually to check that it runs and so that GitHub knows which jobs will run.
...
<a id="TMP_1ab2"></a>
**Part 1.6:  Open the workshop in MATLAB Online or in your MATLAB Desktop**
...
**Part 1.7:  Switch to a development branch**
